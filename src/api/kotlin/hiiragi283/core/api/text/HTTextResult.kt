 ...
 * @since 0.4.0
 */
fun <T> HTTranslation.toTextResult(color: TextColor): HTTextResult<T> = HTTextResult.error(this.translateColored(color))
 ...
 * @since 0.4.0
 */
fun <T> HTTranslation.toTextResult(color: TextColor, vararg args: Any?): HTTextResult<T> =
