...
inline fun <T> HTWeatheringCoppers(initWeathering: (HTCopperPhase) -> T, initWaxed: (HTCopperPhase) -> T): HTWeatheringCoppers<T> = HTWeatheringCoppers(
    HTCopperCollection(initWeathering),
    HTCopperCollection(initWaxed),
)
