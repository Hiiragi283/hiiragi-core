 ...
 * @see DataMapProvider
 */
abstract class HTDataMapGenTask<T : Any, R : Any>(private val type: DataMapType<R, T>) : HTServerResourceGenTask {
    ...
    override fun accept(sink: ResourceSink) {
        ...
        ConditionalOps
            ...
            .encodeStart(JsonOps.INSTANCE, WithConditions(file).toOptional())
            .ifSuccess {
