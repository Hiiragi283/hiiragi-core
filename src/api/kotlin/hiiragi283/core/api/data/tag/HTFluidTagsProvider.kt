 ...
 * @since 0.10.0
 */
abstract class HTFluidTagsProvider(output: PackOutput, lookupProvider: CompletableFuture<HolderLookup.Provider>, modId: String) :
    HTTagsProvider.DataGen<Fluid>(output, Registries.FLUID, lookupProvider, modId) {
    //    Extensions    //
