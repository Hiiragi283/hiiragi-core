...
data object HTDynamicDataRegister : HTRecipeProviderContext() {
    ...
    override val exporter: HTRecipeExporter = HTRecipeExporter { id: ResourceLocation, recipe: Recipe<*>, _ -> addToData(Registries.RECIPE.createKey(id), Recipe.CODEC, recipe) }
    ...
    fun addLootTable(block: Block, factory: (Block) -> LootTable.Builder) {
        addToData(block.lootTable, LootTable.DIRECT_CODEC, factory(block).build())
    }
