...
class HTDeferredFluidTypeRegister(namespace: String) : HTDeferredRegister<FluidType>(NeoForgeRegistries.Keys.FLUID_TYPES, namespace) {
    ...
    override fun <I : FluidType> createHolder(registryKey: RegistryKey<FluidType>, key: ResourceLocation): HTDeferredFluidType<I> = HTDeferredFluidType(key)
    ...
    override fun <I : FluidType> register(name: String, func: Function<ResourceLocation, out I>): HTDeferredFluidType<I> = super.register(name, func) as HTDeferredFluidType<I>
