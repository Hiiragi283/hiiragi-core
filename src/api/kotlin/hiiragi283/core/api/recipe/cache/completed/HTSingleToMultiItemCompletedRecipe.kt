 ...
 */
abstract class HTSingleToMultiItemCompletedRecipe<INPUT : Any, RECIPE : Function<INPUT, out Iterable<ItemStack>>>(
    recipe: RECIPE,
    ...
    private val output: Iterable<ItemStack> = recipe.apply(inputHandler.getStack())
