...
data class HTItemContainerContext(val hand: Optional<InteractionHand>, val stack: ItemStack) {
    companion object {
        ...
        val CODEC: BiCodec<RegistryFriendlyByteBuf, HTItemContainerContext> = BiCodec.composite(
            BiCodecs.enum<InteractionHand>().optionalFieldOf("hand").forGetter(HTItemContainerContext::hand),
            VanillaBiCodecs.ITEM_STACK.fieldOf("stack").forGetter(HTItemContainerContext::stack),
