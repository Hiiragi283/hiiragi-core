...
fun <P1, P2, P3, R> ((P1, P2, P3) -> R).partially3(p1: P1, p2: P2, p3: P3): () -> R = { this(p1, p2, p3) }

// (P1, P2, P3, P4) -> R
fun <P1, P2, P3, P4, R> ((P1, P2, P3, P4) -> R).partially1(p1: P1): (P2, P3, P4) -> R = { p2: P2, p3: P3, p4: P4 -> this(p1, p2, p3, p4) }

fun <P1, P2, P3, P4, R> ((P1, P2, P3, P4) -> R).partially2(p1: P1, p2: P2): (P3, P4) -> R = { p3: P3, p4: P4 -> this(p1, p2, p3, p4) }
