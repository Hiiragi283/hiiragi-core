...
class HTBasicDoubleItemToMultiOutputRecipeCategoryExtension<RECIPE : HTBasicDoubleItemToMultiOutputRecipe> :
    HTDoubleItemToMultiOutputRecipeCategoryExtension<RECIPE> {
