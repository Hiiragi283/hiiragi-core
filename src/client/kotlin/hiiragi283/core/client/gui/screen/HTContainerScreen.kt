...
abstract class HTContainerScreen<MENU : HTContainerMenu<*>> :
    ...
    HTAbstractGui {
    constructor(menu: MENU, inventory: Inventory, title: Component) : super(menu, inventory, title)

    constructor(menu: MENU, inventory: Inventory, title: Component, imageWidth: Int, imageHeight: Int) : super(
        menu,
        inventory,
        title,
        imageWidth,
