...
data object HTFluidCapabilities : HTMultiCapability<IFluidHandler, IFluidHandlerItem> {
    override val block: BlockCapability<IFluidHandler, Direction?> get() = Capabilities.FluidHandler.BLOCK
    override val entity: EntityCapability<IFluidHandler, Direction?> get() = Capabilities.FluidHandler.ENTITY
    override val item: ItemCapability<IFluidHandlerItem, Void?> get() = Capabilities.FluidHandler.ITEM
