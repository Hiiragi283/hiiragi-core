...
data object HTItemCapabilities : HTMultiCapability.Simple<IItemHandler> {
    override val block: BlockCapability<IItemHandler, Direction?> get() = Capabilities.ItemHandler.BLOCK
    override val entity: EntityCapability<IItemHandler, Direction?> get() = Capabilities.ItemHandler.ENTITY_AUTOMATION
    override val item: ItemCapability<IItemHandler, Void?> get() = Capabilities.ItemHandler.ITEM
