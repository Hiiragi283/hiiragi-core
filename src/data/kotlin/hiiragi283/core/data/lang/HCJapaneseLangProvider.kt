...
class HCJapaneseLangProvider(output: PackOutput) :
    HTLanguageProvider(output, HiiragiCoreAPI.MOD_ID, HTLangTypes.JA_JP),
    HCLanguageProvider {
    override fun addTranslations() {
        ...
        add(HCBlocks.NETHER_CRUCIBLE, "ネザーるつぼ")
        // Fluid
        ...
        add(VanillaRecipeTypes.SMOKING, "燻製器")
        add(VanillaRecipeTypes.BREWING, "醸造")

        add(HCRecipeTypes.CHARGING, "落雷によるチャージ")
        add(HCRecipeTypes.CRUSHING, "粉砕")
        add(HCRecipeTypes.MELTING, "融解")

        // Translation
        translation()

        // Jade
        add(HCCrucibleJadeProvider.Client, "るつぼ")
    }
