...
class HTSingleItemEmiRecipe<RECIPE : HCSingleItemRecipe<*>>(category: HTEmiRecipeCategory, holder: RecipeHolder<RECIPE>) :
    ...
    companion object {
        @JvmStatic
        fun charging(holder: RecipeHolder<HCLightningChargingRecipe>): HTSingleItemEmiRecipe<HCLightningChargingRecipe> =
            HTSingleItemEmiRecipe(HCEmiRecipeCategories.CHARGING, holder)
