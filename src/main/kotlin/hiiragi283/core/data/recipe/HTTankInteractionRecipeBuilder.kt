...
data object HTTankInteractionRecipeBuilder {
    @JvmStatic
    inline fun emptying(builderAction: Emptying.() -> Unit): Emptying = Emptying().apply(builderAction)

    @JvmStatic
    inline fun filling(builderAction: Filling.() -> Unit): Filling = Filling().apply(builderAction)
