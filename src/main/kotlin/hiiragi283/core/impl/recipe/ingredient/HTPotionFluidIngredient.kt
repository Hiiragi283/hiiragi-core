package hiiragi283.core.impl.recipe.ingredient
...
class HTPotionFluidIngredient(val potions: HolderSet<Potion>, val bottleType: HTBottleType) : FluidIngredient() {
    ...
    override fun generateFluids(): Stream<Holder<Fluid>> = HTPotionFluidManager.fluidHandlers.keys.stream()

    override fun display(): SlotDisplay = HTPotionFluidManager.fluidHandlers.keys
