...
data object HTEnergyCapabilities : HTMultiCapability.Simple<IEnergyStorage> {
    override val block: BlockCapability<IEnergyStorage, Direction?>
        get() = Capabilities.EnergyStorage.BLOCK
    override val entity: EntityCapability<IEnergyStorage, Direction?>
        get() = Capabilities.EnergyStorage.ENTITY
    override val item: ItemCapability<IEnergyStorage, Void?>
