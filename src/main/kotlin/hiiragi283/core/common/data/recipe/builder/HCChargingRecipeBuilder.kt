...
import hiiragi283.core.api.data.recipe.builder.HTEnergizedRecipeBuilder
...
class HCChargingRecipeBuilder : HTEnergizedRecipeBuilder(HTConst.CHARGING) {
    companion object {
        @JvmStatic
    ...
    init {
        energy = HCChargingRecipe.DEFAULT_ENERGY
    }
