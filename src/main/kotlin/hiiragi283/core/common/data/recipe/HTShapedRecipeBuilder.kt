 ...
 * @since 21.1.0
 */
class HTShapedRecipeBuilder : HTCraftingRecipeBuilder<ShapedRecipe>(HTConst.SHAPED) {
    companion object {
        @JvmStatic
    ...
    override fun createRecipe(group: String, category: CraftingBookCategory, result: ItemStack): ShapedRecipe = ShapedRecipe(
        group,
        category,
