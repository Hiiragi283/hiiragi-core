...
data object HCRecipeBuilders {
    @JvmStatic
    inline fun brewing(builderAction: HTItemOrFluidRecipeBuilder<HCBrewingRecipe>.() -> Unit): HTItemOrFluidRecipeBuilder<HCBrewingRecipe> {
        contract {
            callsInPlace(builderAction, InvocationKind.EXACTLY_ONCE)
        }
        return HTItemOrFluidRecipeBuilder(HTConst.BREWING, ::HCBrewingRecipe).apply(builderAction)
    }
