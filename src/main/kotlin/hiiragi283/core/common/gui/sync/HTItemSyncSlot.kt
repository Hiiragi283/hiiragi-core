 ...
 * @since 0.8.0
 * @see mekanism.common.inventory.container.sync.SyncableItemStack
 */
class HTItemSyncSlot(private val getter: Supplier<ItemStack>, private val setter: Consumer<ItemStack>) : HTIntSyncSlot {
    ...
    constructor(slot: HTResourceSlot.Basic<HTItemResourceType>) : this(slot::getItemStack, slot::setStack)
